...
class CreateNinthmedicalbatchesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ninthmedicalbatches', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ninthmedicalbatches');
    }
}

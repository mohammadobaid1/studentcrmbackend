...
class CreateSecondyearpreengineeringbatchesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('secondyearpreengineeringbatches', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('secondyearpreengineeringbatches');
    }
}
